export const questionnaireCategories = [
  {
    ...
    title: "Build",
    items: [
      { id: "b_manual", label: "Manual trigger", type: "yes_no_na", description: "Ali je cevovod mogoče sprožiti ročno prek uporabniškega vmesnika?" },
      { id: "b_triggers", label: "Other triggers (Push, PR, Sched, API)", type: "text", description: "Naštejte ostale načine proženja (npr. na vsak push, na nov PR, časovno...)" },
      { id: "b_dedicated", label: "Uses dedicated build server (outside GitHub runner)", type: "yes_no_na", description: "Ali za gradnjo uporabljate lastne/dedicirane strežnike, ki niso del standardnega ponudnika (npr. GitHub-ovih oblačnih instanc)?" },
      { id: "b_logging", label: "Explicit build logging", type: "yes_no_na", description: "Ali so dnevniki (logi) gradnje podrobno beleženi in dostopni za kasnejšo analizo?" },
      { id: "b_cache", label: "Dependency caching", type: "yes_no_na", description: "Ali se pri gradnji uporablja predpomnjenje odvisnosti (caching) za hitrejše izvajanje?" },
      { id: "b_artifacts", label: "Build artifacts are stored", type: "yes_no_na", description: "Ali se po uspešni gradnji zgrajeni paketi/artefakti varno shranijo?" },
